...
class ArchitectureRulesTest {
  ...
  @ArchTest
  static final ArchRule controllers_should_be_in_a_controller_package =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule services_should_be_in_a_service_package =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule repositories_should_be_in_a_repository_package =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule mappers_should_be_in_a_repository_package =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule no_bypass_of_proxy_logic_for_async_methods =
      no_classes_should_directly_call_other_methods_declared_in_the_same_class_that_are_annotated_with(
          Async.class);

  @ArchTest
  static final ArchRule no_bypass_of_proxy_logic_for_transactional_methods =
      no_classes_should_directly_call_other_methods_declared_in_the_same_class_that_are_annotated_with(
          Transactional.class);
